...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getTasks = function () {
        var _this = this;
        var t = this._httpService.getAllTasks();
        t.subscribe(function (data) {
            console.log("Got 'em all!", data);
            _this.tasks = data["tasks"];
        });
    };
    AppComponent.prototype.getTask = function (task) {
        var _this = this;
        var t = this._httpService.getTask(task);
        t.subscribe(function (data) {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getTask = function (task) {
...
var TaskComponent = /** @class */ (function () {
    ...
    ], TaskComponent.prototype, "getTask", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\Administrator\mean_stack\angular\RestfulTasksNested\src\main.ts */"./src/main.ts");
